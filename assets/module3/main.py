...
def init_connection_pool() -> sqlalchemy.engine.base.Engine:
    ...
    if os.environ.get("INSTANCE_CONNECTION_NAME"):
        # Either a DB_USER or a DB_IAM_USER should be defined.
        # If both are defined, DB_IAM_USER takes precedence.
        return connect_with_connector()

    raise ValueError(
        "Missing database connection INSTANCE_CONNECTION_NAME"
    )
